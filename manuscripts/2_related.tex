...
Darvariu et al.~\cite{Darvariu2024} established the foundational result
...
Waxman et al.~\cite{Waxman2024} proposed LLM-initialised differentiable
...
\rev{Wu et al.~\cite{Wu2025} critically re-evaluated the role of LLMs in
...
Bayesian Online Changepoint Detection (BOCPD)~\cite{Adams2007} for
...
Liu et al.\ \cite{Liu2024Survey} and Jin et al.\
...
agents~\cite{Kang2025Copilot}, LLM understanding of causal
...
operators~\cite{Han2025GeoMaNO}, physics-informed operator
learning~\cite{Zanardi2023PhysicsInformed}, and neural operators
for multi-task control~\cite{Sewell2026Operators}.
...
semi-stationary time series~\cite{Assaad2024Semi},
...
and causal foundation models for time series~\cite{CausalFoundation2025}.
...
and Transformer-based temporal discovery~\cite{Zhang2024GraphCausal}
...
analysis~\cite{Rudd2023Churn}, and the MSM identifiability
framework has been extended to instantaneous effects and
exponential family noise~\cite{BalsellsRodas2026MSM}.